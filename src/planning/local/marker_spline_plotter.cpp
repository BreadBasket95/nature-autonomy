...
namespace nature {
  namespace planning{
    ...
    MarkerPlotter::MarkerPlotter(std::shared_ptr<nature::visualization::VisualizerBase> visualizer, const std::string & cost_vis,
    ...
    nature::msg::Marker MarkerPlotter::get_marker_msg(int type, int id, bool is_blocked) const{
    ...
    void MarkerPlotter::Display(bool save, const std::string & ofname, int nx, int ny) {
      if (!map_set_)return;
