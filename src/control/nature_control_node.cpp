 ...
 *
 * Node to subscribe to a trajectory message and
...
int main(int argc, char *argv[]){
  ...
  bool display_markers = display == "markers";
  auto next_waypoint_pub = display_markers ? n->create_publisher<nature::msg::PointStamped>("nature/control_next_waypoint", 1) : nullptr;
